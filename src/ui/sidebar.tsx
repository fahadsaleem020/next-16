    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-transparent! shadow-none p-2 text-sidebar-foreground w-(--sidebar-width) [&>button]:hidden"
          style={
            {
          ...
          side={side}
        >
          <Box className="bg-background h-full shadow-lg rounded-xl border">
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex min-h-0 flex-1 flex-col gap-2 overflow-auto scroll group-data-[collapsible=icon]:overflow-hidden", className)}
      {...props}
    />
  );
}
